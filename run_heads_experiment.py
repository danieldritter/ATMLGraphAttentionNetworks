...
"""
Runs an experiment with different combinations of attention heads and output features.
All GAT layers generate the same number of output features, but with differing numbers of
attention heads (e.g. 2 heads computing 4 features each vs. 4 heads computing 2 features each)
"""
...
# Main code
def main():
    heads_feat_pairs = [(2,16),(4,8),(8,4),(16,2)]
    all_avgs = {}
    ...
    for pair in all_avgs:
        print(f"Num Heads: {pair[0]}, Num Features: {pair[1]}, Test Accuracy: {all_avgs[pair]}")
